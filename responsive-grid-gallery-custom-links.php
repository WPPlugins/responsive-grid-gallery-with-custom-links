...
final class ABCF_RGGCL {
    ...
    private function includes() {
        ...
        require_once ABCFRGGCL_PLUGIN_DIR . 'library/utility-all.php';

        require_once ABCFRGGCL_PLUGIN_DIR . 'deprecated/inc.php';
        ...
        if( is_admin() ) {
            ...
            require_once ABCFRGGCL_PLUGIN_DIR . 'deprecated/admin.php';

//            require_once ABCFRGGCL_PLUGIN_DIR . 'admin/mbox-gallery-options.php';
//            require_once ABCFRGGCL_PLUGIN_DIR . 'admin/mbox-gallery-field-order.php';
//
//            require_once ABCFRGGCL_PLUGIN_DIR . 'admin/mbox-item.php';
//            require_once ABCFRGGCL_PLUGIN_DIR . 'admin/mbox-menu-tabs.php';
