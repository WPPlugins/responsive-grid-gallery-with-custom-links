<?php
function abcfrggcl_v_tabs_manager_div_s( $mgrID ){

    //---Manager START
    echo abcfl_html_tag( 'div', 'abcfrggcl_VTabsMgr_' . $mgrID, 'abcflVTabsMgr' );
    //abcfl_html_tag_cls('div', 'abcflClr', true);
}

function abcfrggcl_v_tabs_render_nav_tab( $cls, $lbl1, $lbl2='', $url='#'){
