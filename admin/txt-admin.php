...
//--------------------------------
        ...
        case 32:
            ...
            break;
        case 33:
            $out = __('Image ID', 'responsive-grid-gallery-custom-links');
            break;
        case 34:
...
//--------------------------------
       ...
       case 44:
            ...
            break;
        case 45:
            $out = __('Gallery Item Order', 'responsive-grid-gallery-custom-links');
            break;
        case 46:
...
//--------------------------------
        ...
        case 55:
            ...
            break;
        case 56:
            $out = __('Add a New Field', 'responsive-grid-gallery-custom-links');
            break;
        case 57:
...
//--------------------------------
        ...
        case 83:
            ...
            break;
        case 84:
            $out = __('Gallery - Category Filter', 'responsive-grid-gallery-custom-links');
            break;
        case 85:
            $out = __('To open a link in a new window, add prefix <span class="abcflFontW700 abcflFontS16 abcflGreen">NT</span> and space. Example: NT http://abcfolio.com/', 'responsive-grid-gallery-custom-links');
            break;
        case 86:
...
//--------------------------------
        ...
        case 112:
            ...
            break ;
        case 113:
            $out = __('To create text link with the same addres as an image link:', 'responsive-grid-gallery-custom-links');
            break;
        case 114:
            $out = __('Add a Hyperlink field.', 'responsive-grid-gallery-custom-links');
            break;
        case 115:
            $out = __('Enter <span class="abcflFontW700 abcflFontS16 abcflGreen">IL</span> as an URL.', 'responsive-grid-gallery-custom-links');
            break;
        case 116:
            $out = __('Save Changes');
            break ;
...
//--------------------------------
       case 200:
        ...
        case 207:
            ...
            break;
        case 208:
            $out = __('Gallery items will be sorted in ascending alphabetical order, according to the Sort Text (from Gallery Item).', 'responsive-grid-gallery-custom-links');
            break;
        case 209:
...
//--------------------------------
        ...
        case 215:
            ...
            break;
        case 216:
            $out = __('Optional. Text to sort items by. Leave empty if you\'ll sort items manually.', 'responsive-grid-gallery-custom-links');
            break;
        case 217:
...
//--------------------------------
        case 220:
            ...
            break;
        case 221:
            $out = __('To filter by category, replace the word \'slug\' with the category slug.', 'responsive-grid-gallery-custom-links');
            break;
        case 222:
...
//--------------------------------
        ...
        case 237:
            ...
            break;
        case 238:
            $out = __('Example: [abcf-rggcl id="5586" category="landscape"]', 'responsive-grid-gallery-custom-links');
            break;
        case 239:
...
//--------------------------------
        ...
        case 245:
            ...
            break;
        case 246:
            $out = __('Create a new Post or Page.', 'responsive-grid-gallery-custom-links');
            break;
        case 247:
            $out = __('Copy the shortcode (from above) and paste it into the Post or Page content editor.', 'responsive-grid-gallery-custom-links');
            break;
        case 248:
            $out = __('Save the page.', 'responsive-grid-gallery-custom-links');
            break;
        case 249:
            $out = __('Open the newly created page.', 'responsive-grid-gallery-custom-links');
            break;
//--------------------------------
        case 250:
            $out = __('', 'responsive-grid-gallery-custom-links');
...
//--------------------------------
        case 350:
            ...
            break;
        case 351:
            $out = __('Screen Min Width: 992px.', 'responsive-grid-gallery-custom-links');
            break;
        case 352:
            $out = __('Screen Min Width: 768px.', 'responsive-grid-gallery-custom-links');
            break;
        case 353:
            $out = __('Number of columns for screens 1200px and up. Used for all screens if other column settings (below) not selected.', 'responsive-grid-gallery-custom-links');
            break;
        case 354:
            ...
            break;
        case 355:
            $out = __('Screen between 992 and 1200px. (iPad lanscape mode)', 'responsive-grid-gallery-custom-links');
            break;
        case 356:
            $out = __('Screen between 768 and 992px. (iPad portrait mode)', 'responsive-grid-gallery-custom-links');
            break;
        case 357:
...
//To open a link in a new window, add prefix NT. There should be a space between NT and the URL.
